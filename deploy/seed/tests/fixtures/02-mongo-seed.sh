...
#   - ${SEED_ROOT:-/seed}/api_role.json
#   - ${SEED_ROOT:-/seed}/product.json
#   - ${SEED_ROOT:-/seed}/product-quantity-history.json
#
...
#   api_role               ← ${SEED_ROOT:-/seed}/api_role.json               (--jsonArray)
#   product                ← ${SEED_ROOT:-/seed}/product.json                (--jsonArray)
#   product_quantity_history ← ${SEED_ROOT:-/seed}/product-quantity-history.json (--jsonArray)
...
mongoimport --uri "$MONGO_URI" --jsonArray --db ecommerce_inventory --collection api_role --file ${SEED_ROOT:-/seed}/api_role.json
mongoimport --uri "$MONGO_URI" --jsonArray --db ecommerce_inventory --collection product --file ${SEED_ROOT:-/seed}/product.json
...
mongoimport --uri "$MONGO_URI" --jsonArray --db ecommerce_inventory --collection productQuantityHistory --file ${SEED_ROOT:-/seed}/product-quantity-history.json
